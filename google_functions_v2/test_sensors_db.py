...
import sensors_db_fake as sdbf
import sensor as sen



class TestSensorsDBFake(unittest.TestCase):
    def setUp(self):
        self.db: sdbf.SensorsDBFake = sdbf.SensorsDBFake()
        self.tube_1 = "example"
        self.tube_2 = "test"
        self.good_datum_one_1: dd.DeviceDatum = dd.DeviceDatum({self.tube_1: 25.1}, dt.datetime(2011, 11, 4, 0, 0), "")
        self.good_datum_one_2: dd.DeviceDatum = dd.DeviceDatum({self.tube_1: 28.2}, dt.datetime(2011, 11, 5, 0, 0), "")
        self.good_datum_two: dd.DeviceDatum = dd.DeviceDatum({self.tube_1: 25.1, self.tube_2: 25.2}, dt.datetime(2011, 11, 6, 0, 0), "")
        self.err_datum_one_with_message: dd.DeviceDatum = dd.DeviceDatum({self.tube_2: 26.1}, dt.datetime(2012, 12, 5, 0, 0), "error")
        self.err_datum_one_with_message_2: dd.DeviceDatum = dd.DeviceDatum({self.tube_2: 26.1}, dt.datetime(2012, 12, 5, 0, 0), "error2")
