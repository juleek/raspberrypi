...
class TestSensorsDBBQ(unittest.TestCase):
    def setUp(self):
        ...
        # bigquery.Client().delete_table('tarasovka.test.test_db', not_found_ok=True)
        self.db: sdbq.SensorsDBBQ = sdbq.SensorsDBBQ(project="tarasovka", dataset_id="test", table_name=f"test_db{s}", location="europe-west2")
        self.tube_1 = "example"
        self.tube_2 = "test"
