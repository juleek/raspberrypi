...
TSensorPoller::TSensorPoller(TSensorInfo si, const uint32_t MyInd) noexcept {
...
void TSensorPoller::OnTimerShot() {
   ...
   emit                        NewTemperatureGot(MyIndex, std::get<0>(ErrStrAndTemp), std::get<1>(ErrStrAndTemp));
